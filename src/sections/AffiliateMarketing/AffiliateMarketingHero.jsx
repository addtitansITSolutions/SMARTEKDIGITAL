...
const AffiliateMarketingHero = () => {
  const scrollToNext = () => {
    document.getElementById("affiliate-intro")?.scrollIntoView({
      behavior: "smooth",
    });
  };
    ...
    <section className="relative min-h-[100svh] overflow-hidden bg-[var(--dark)] text-white">
      ...
      <div className="relative z-10 mx-auto flex min-h-[100svh] w-full max-w-[1440px] flex-col px-5 pb-8 pt-28 sm:px-8 sm:pt-32 lg:px-12 lg:pt-36">
        ...
        <div className="grid flex-1 items-center gap-14 py-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-20 lg:py-16">
          ...
          <div className="max-w-[800px]">
            ...
            >
              ...
              partnerships
              <br />
              <span className="text-[var(--primary)]">into growth.</span>
            </motion.h1>
            ...
            >
              We build affiliate strategies that connect your brand with
              relevant partners, expand your reach, and create performance-led
          ...
          >
            <div className="relative aspect-square overflow-hidden border border-white/10 bg-white/[0.03]">
              <img
                src="/Services/AffiliateMarketing.png"
              ...
              <div className="absolute left-5 right-5 top-5 sm:left-7 sm:right-7 sm:top-7">
                <div className="flex items-center justify-between border border-white/15 bg-[var(--dark)]/80 px-4 py-3 backdrop-blur-sm">
              ...
              <div className="absolute bottom-6 left-6 right-6 sm:bottom-8 sm:left-8 sm:right-8">
                ...
                <p className="max-w-[400px] font-[var(--font-display)] text-xl font-medium leading-tight tracking-[-0.03em] text-white sm:text-2xl">
                  The right partners can take your reach further.
                </p>
              </div>
            </div>
        ...
        >
          ...
          <span className="font-[var(--font-body)] text-[9px] font-bold uppercase tracking-[0.18em] text-white/35">
            Partnerships · Acquisition · Performance · Scale
          </span>
        </motion.div>
      </div>
    </section>
